...
function App2(props) {
    ...
    const handleRowCheck = (row, checked) => {
        let data = state.listData.slice();
        let index = state.listData.indexOf(row);
    ...
    const handleAllCheck = (checked) => {
        ...
        let data = state.listData.map(row => {
            ...
            <Tabs tabPosition={state.position} style={{ height: "100%", }}>
                ...
                <TabPanel title="售后服务申请单">
                    <div>
                        ...
                        <Xxx>
                            <DataGrid data={state.listData} renderDetail={renderDetail} style={{ width: '1000px' }} >
